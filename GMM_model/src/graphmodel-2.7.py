...
data_dir_append = raw_input("data file: ")
log_dir_append = data_dir_append

INPUT_NODE = int(raw_input("feature size: "))
OUTPUT_NODE = 10
LAYER1_NODE = 100
BATCH_SIZE = 100
...
TRAINING_STEPS = int(raw_input("TRAINING STEPS: "))
THETA = 2.0
...
train_type = int(raw_input("Train Type: 1.train all | 2.no trans | 3.no_thre | 4.weight_one | 5.weighted: "))
if train_type == 1:
    train_all = True
    print("1.train all")
    ...
    TRANSFER_FRE = int(raw_input("TRANSFER FRE: "))
elif train_type == 4:
    weight_one = True
    print("4.weight_one")
    ...
    weighted = True
    print("5.weighted")
    WEIGHT_THRESHOLD = float(raw_input("WEIGHT_THRESHOLD: "))
    TRANSFER_FRE = int(raw_input("TRANSFER FRE: "))
